...
function [nrPuschRatematchLen] = wnNrPhyPuschRateMatchlen_rx (NrUlUlschPDUs, ...
                                                              dmrs_pr_prb, ...
                                                              nPtrsSyms, ...
                                                              dmrsCdmG, ...
                                                              nPrbAllocated)
...
% transmission or not.
orthoCdmGroup = sum (dmrsCdmG);

% Number of REs allocated to NR PDSCH
no_of_REs_allocated = nPrbAllocated * 12 * NrUlUlschPDUs.nNrOfSymbols ... % Total REs for PDSCH 
                      - NrUlUlschPDUs.nNrofChunks*(NrUlUlschPDUs.nDMRSpSymb+NrUlUlschPDUs.nCpsam*2)*length(NrUlUlschPDUs.Dmrssymbidx) ...   % REs to leave for PUSCH and for orthogonal DMRS
                      - nPtrsSyms;                                        % REs to leave for PTRS
             
                  
% Consider Number of Layers and Modulation order used for PDSCH
nrPuschRatematchLen = no_of_REs_allocated *  NrUlUlschPDUs.nNrOfLayers * NrUlUlschPDUs.modOrder;
