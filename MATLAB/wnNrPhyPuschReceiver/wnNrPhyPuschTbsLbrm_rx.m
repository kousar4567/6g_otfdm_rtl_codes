...
function [TBS_LBRM] = wnNrPhyPuschTbsLbrm_rx(NrUlUlschPDUs)
...
if NrUlUlschPDUs.nBWPSize < 33
    n_PRB_LBRM = 32;
elseif (33 <= NrUlUlschPDUs.nBWPSize && NrUlUlschPDUs.nBWPSize <= 66)
    n_PRB_LBRM = 66;
elseif (67 <= NrUlUlschPDUs.nBWPSize && NrUlUlschPDUs.nBWPSize<= 107)
    n_PRB_LBRM = 107;
elseif (108 <= NrUlUlschPDUs.nBWPSize && NrUlUlschPDUs.nBWPSize<= 135)
    n_PRB_LBRM = 135;
elseif (136 <= NrUlUlschPDUs.nBWPSize && NrUlUlschPDUs.nBWPSize<= 162)
    n_PRB_LBRM = 162;
elseif (163 <= NrUlUlschPDUs.nBWPSize && NrUlUlschPDUs.nBWPSize<= 217)
    n_PRB_LBRM = 217;
elseif 217 < NrUlUlschPDUs.nBWPSize
    n_PRB_LBRM = 273;
end
